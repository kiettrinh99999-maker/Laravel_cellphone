                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <li><a href="{{route('scard')}}"><i class="fa fa-user"></i> My Cart</a></li>
                            <li><a href="{{route('scheckout')}}"><i class="fa fa-user"></i> Checkout</a></li>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="@yield('active_Shop_page')"><a href="{{route('spage')}}">Shop page</a></li>
                        <li class="@yield('active_Single_product')"><a href="{{route('sprod')}}  ">Single product</a>
                        </li>
                        <li class="@yield('active_Cart')"><a href="{{route('scard')}}">Cart</a></li>
                        <li class="@yield('active_Check')"><a href="{{route('scheckout')}}">Checkout</a></li>
                        <li class="@yield('active_')"><a href="#">Category</a></li>
                        <li class="@yield('active_')"><a href="#">Others</a></li>
